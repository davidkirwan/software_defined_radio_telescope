...
\begin{enumerate}
  ...
  \item A rudimentary \gls{SDR} solution to filter or flag human radio interference from observations.
  \item A rudimentary \gls{SDR} solution to filter or flag natural radio interference from observations.
\end{enumerate} 

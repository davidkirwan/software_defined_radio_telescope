...
Figure. \ref{fig:dam_emissions_spectrum} shows an ideal case of the \textit{S-Burst} and \textit{L-Burst} \gls{DAM} emissions and what they might look like on a frequency spectrum graph. S-Burst emissions are short, generally $1-10\times10^{-3}s$ long while L-Bursts can be \textit{0.5-5s} in length.
...
\addcontentsline{toc}{section}{Digital Signal Processing}

...
The aim of this experiment was to determine the minimal hardware which was computationally capable enough to collect data, while also performing any data analytical or processing tasks required by the system.

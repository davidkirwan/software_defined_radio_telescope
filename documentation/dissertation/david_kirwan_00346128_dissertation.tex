...
An opportunity to validate the HackRF transceiver arose with the announcement of an experiment by the Radio Society of Great Britain. A radio propagation experiment was designed to coincide with the partial solar eclipse due to occur on 20th March 2015. As can be seen in Figure: \ref{fig:solar_eclipse_scale} and in Figure: %TODO 
Ireland would experience upto 90\% totality during the eclipse. According to \citet{RSGB-15}, the high energy ultra violet radiation from the sun affects the ability of Earth's ionosphere to reflect or absorb radio signals during the day. Whereas at night time, the

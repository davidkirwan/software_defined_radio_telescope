...
Using solar data collected by the national weather service, MET Eireann \citep{MET-15} and \citep{ECAD-15}, a regression model was produced to calculate how big the battery array, an  

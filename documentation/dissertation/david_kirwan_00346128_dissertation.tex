...
A power graph was generated from I/Q data collected during the 20th March 2015 for the solar eclipse radio propagation experiment. The plot shows the power rise as the eclipse reaches max totality and can be seen in Figure: \ref{fig:gnuradio_companion_flowgraph_06}.
...
\begin{figure}	
	...
	\begin{subfigure}[t]{8cm}
		...
		\caption{GNURadio flow-graph to plot total power for a band of frequency}
	...
	\end{subfigure}
	\caption{GNURadio flow-graphs to generate power total power plots from saved data}\label{fig:gnuradio_companion_flowgraph}
\end{figure}
%

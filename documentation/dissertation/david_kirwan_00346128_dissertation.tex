...
In order to begin collecting data for analysis, a dual dipole antenna (Figure: \ref{fig:dual_dipole_antenna_array}) was constructed and deployed at a test site for verification. 
...
A Tektronics SA2600 spectrum analyser was connected to the antenna and left for a number of hours to determine the
suitability of the site. As can be seen in Figure: \ref{fig:site_survey_spec_analyser}, the ambient \gls{RF} noise at the site was quite high, ranging between -80dB and -70dB on average. Similar readings were taken using the HackRF while attached to the antenna as show in Figure: \ref{fig:site_survey_hackrf}.

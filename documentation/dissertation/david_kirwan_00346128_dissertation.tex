...
\begin{enumerate}
	\item Design a GNURadio flow-graph prototype to generate a test signal
	\item Design a GNURadio flow-graph prototype to which filters a test signal using a bandpass filter
	\item Design a GNURadio flow-graph which incorporates the total power meter in order to produce a power plot
\end{enumerate}


As with hardware radiometers, the signal being measured can be split up into small chunks using bandpass filters
